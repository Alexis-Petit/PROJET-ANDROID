...
public class TableSorties
{
    ...
    public static void create(SQLiteDatabase bdd)
    {
        ...
        // mise au point
        bdd.execSQL("INSERT INTO Sorties VALUES (1, '27/02/2017', 'Lannion', 'esssai', '3.5')");
        bdd.execSQL("INSERT INTO Sorties VALUES (2, '27/02/2017', 'Lannion', 'essai2', '4.5')");
    }
    ...
    */
    ...
    public static void delete(SQLiteDatabase bdd, Sortie sortie)
    {
        long id = bdd.delete(NOM, "_id = ?" ,new String[] {String.valueOf(sortie.getId())});
    }
}
